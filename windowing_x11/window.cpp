...
window * oswindow_get(Display * pdisplay, Window window, Visual * pvisual, int iDepth, int iScreen, Colormap colormap)
{
...
iptr get_window_long_ptr(window * pdata, int nIndex)
{
...
iptr set_window_long_ptr(window * pdata, int nIndex, iptr i)
{
