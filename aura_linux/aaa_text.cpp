...
::e_status gdiplus_draw_text(::draw2d::graphics* pgraphicsParam, ::draw2d::path* ppathParam, const ::scoped_string & scopedstr, double_rectangle& rectParam, const ::e_align & ealign, const ::e_draw_text & edrawtext, ::write_text::font* pfontParam, double dFontWidth, ::draw2d::brush* pbrushParam, bool bMeasure)
{
   ...
   try
   {
      ...
      if (dFontWidth == 1.0)
      {
         ...
         Gdiplus::RectF float_rectangle((Gdiplus::REAL) rectParam.left, (Gdiplus::REAL) rectParam.top, (Gdiplus::REAL) (width(rectParam) * dFontWidth), (Gdiplus::REAL) (height(rectParam)));
      ...
      else if (ppath)
      {
         ...
         //Gdiplus::RectF float_rectangle(0, 0, (Gdiplus::REAL) (width(rectParam) * m_pfont->m_dFontWidth), (Gdiplus::REAL) (height(rectParam)));
