...
namespace music
{
   ...
   namespace midi
   {
      ...
      namespace alsa
      {
         ...
         ::e_status midi::translate_os_result(string & strMessage, string & strOsMessage, ::music::midi::particle * pparticle, int64_t iOsResult, const string & strContext, const string & strText)
         {
