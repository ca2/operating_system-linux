...
/* Is information kept by the tool about specific instructions or
   ...
   reused for ___new translations. */
...
/* Events happening in aura to track.  To be notified, pass a callback
   ...
   indicates the thread for whom the ___new memory is being allocated.
...
/* Thread events (not exhaustive)
   ...
   immediately before the ___new thread has come into existence; the ___new
