...
/* Get the file/function/line number of the instruction at address
   ...
   copies the info into the buffer/unsigned int and returns True.  If not, it
...
extern Bool VG_(get_linenum)  ( Addr a, unsigned int* linenum );
