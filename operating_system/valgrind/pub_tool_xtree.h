...
/* If not NULL, the XT_filter_IPs_t function is called when a __new ec is inserted
   in the XTree. 
...
/* Create __new XTree, using given allocation and free function.
...
/* Same as VG_(XT_filter_maybe_below_main) but also filters one top function
   (typically to ignore the top level malloc/__new/... fn). */
...
/* Create a __new file or truncate existing file for printing xtrees in
