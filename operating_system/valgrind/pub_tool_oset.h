...
//
// * Insert: Inserts a memory_new element into the set.  Duplicates are forbidden,
...
// Creates a memory_new empty OSet.
// The memory_new OSet will have the same characteristics as os.
// If os uses a pool allocator, this pool allocator will be shared with
// the memory_new OSet. A shared pool allocator is only deleted (and its memory is
...
// * Size: The number of elements in the set.
//
// * Insert: Inserts a memory_new element into the set.  Note that 'elem' must
