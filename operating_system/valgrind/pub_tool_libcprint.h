...
extern unsigned int VG_(sprintf)  ( HChar* buf, const HChar* format, ... )
                          PRINTF_CHECK(2, 3);

extern unsigned int VG_(vsprintf) ( HChar* buf, const HChar* format, va_list vargs )
                          PRINTF_CHECK(2, 0);

extern unsigned int VG_(snprintf) ( HChar* buf, Int size,
                                       const HChar *format, ... )
                          PRINTF_CHECK(3, 4);

extern unsigned int VG_(vsnprintf)( HChar* buf, Int size,
...
extern unsigned int VG_(printf)   ( const HChar *format, ... )
                          PRINTF_CHECK(1, 2);
extern unsigned int VG_(vprintf)  ( const HChar *format, va_list vargs )
                          PRINTF_CHECK(1, 0);

extern unsigned int VG_(printf_xml)  ( const HChar *format, ... )
                             PRINTF_CHECK(1, 2);

extern unsigned int VG_(vprintf_xml) ( const HChar *format, va_list vargs )
                             PRINTF_CHECK(1, 0);
...
extern unsigned int    VG_(fprintf)  ( VgFile *fp, const HChar *format, ... )
                               PRINTF_CHECK(2, 3);
extern unsigned int    VG_(vfprintf) ( VgFile *fp, const HChar *format, va_list vargs )
                               PRINTF_CHECK(2, 0);
...
extern unsigned int VG_(emit) ( const HChar* format, ... ) PRINTF_CHECK(1, 2);
...
extern unsigned int VG_(message)( VgMsgKind kind, const HChar* format, ... )
   PRINTF_CHECK(2, 3);

extern unsigned int VG_(vmessage)( VgMsgKind kind, const HChar* format, va_list vargs )
   PRINTF_CHECK(2, 0);
...
extern unsigned int VG_(fmsg)( const HChar* format, ... ) PRINTF_CHECK(1, 2);
...
// requested.
extern unsigned int VG_(umsg)( const HChar* format, ... ) PRINTF_CHECK(1, 2);

// This is used for debugging messages that are only of use to developers.
extern unsigned int VG_(dmsg)( const HChar* format, ... ) PRINTF_CHECK(1, 2);
