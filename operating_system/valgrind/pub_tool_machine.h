...
// stack_min is the address of the lowest stack unsigned char,
// stack_max is the address of the highest stack unsigned char.
...
// i.e. the highest addressable unsigned char of the stack.
