...
typedef struct x265_param
{
    ...
    struct
    {
         ...
         * ignored. The lambda tables are process-global, so these memory_new lambda
 ...
 *      of course change if memory_new presets are added in between, but will always be
...
/* x265_encoder_open:
 *      create a memory_new encoder handler, all parameters from x265_param are copied */
...
typedef struct x265_api
{
    ...
    /* add memory_new pointers to the end, or increment X265_MAJOR_VERSION */
} x265_api;
