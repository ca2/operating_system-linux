...
WINBOOL GetClientRect(oswindow hwnd, LPRECT32 lprect);

WINBOOL GetWindowRect(oswindow hwnd, LPRECT32 lprect);

int32_t FillRect(HDC hDC, const RECT32 *lprc, HBRUSH hbr);
