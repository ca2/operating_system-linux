...
namespace draw2d_gdiplus
{
   ...
   bool font::create(::draw2d::graphics * pdraw2dgraphics, char iCreate)
   {
   ...
   ::e_char_set font::calc_char_set(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      return ::write_text::font::calc_char_set(pdraw2dgraphics);
