...
namespace linux
{
   ...
   /*   BOOL shell::_SHGetPathFromIDList(LPCITEMIDLIST pidl, unichar * pszPath)
      {
         ...
         if(!::SHGetPathFromIDListA(pidl, pszPathA))
            return false;
         return ::::str::ch().international::utf8_to_unicode(pszPath, MAX_PATH * 2, pszPathA) ? true : false;
      }
      ...
      {
         string str1, str2;
         ::::str::ch().international::unicode_to_utf8(str1, pExistingFileName);

         ::::str::ch().international::unicode_to_utf8(str2, pNewFileName);
      ...
      {
         string
         ::::str::ch().international::unicode_to_utf8(pszPathA, MAX_PATH * 2, pcsz);
         ...
         ::::str::ch().international::ACPToUnicode(pdata->cFileName, MAX_PATH, data.cFileName);

         ::::str::ch().international::ACPToUnicode(pdata->cAlternateFileName, MAX_PATH, data.cAlternateFileName);
   ...
   //{
   //   char pszPathA[MAX_PATH * 2];
   //   ::::str::ch().international::UnicodeToACP(pszPathA, MAX_PATH * 2, pFileName);
   ...
   //   str.ReleaseBuffer();
   //   ::::str::ch().international::ACPToUnicode(pBuffer, nBufferLength, str);
   ...
   //   ::::str::ch().international::UnicodeToACP(strRootPathName, pRootPathName);
   ...
   //   ::::str::ch().international::ACPToUnicode(
   //      pVolumeNameBuffer,
   ...
   //   string strPath;
   //   ::::str::ch().international::UnicodeToACP(strPath, pszPath);
   //   SHFILEINFOA shia;
   ...
   //   if(iCount < 0)
   //      iCount = ::::str::ch().international::UnicodeToMultiByteCount(uCodePage, pSrcStr);

   //   string str;
   //   char * psz = str.GetBuffer(iCount);

   //   if(::::str::ch().international::UnicodeToMultiByte(uCodePage, psz, iCount, lpSrcStr))
   ...
   //   ::::str::ch().international::UnicodeToACP(strPathName, pszPath);

   //   ::::str::ch().international::UnicodeToACP(strPrefixString, pszPrefix);
   ...
   //{
   //   string strFileName;
   //   ::::str::ch().international::UnicodeToACP(strFileName, pFileName);
   ...
   //   str.ReleaseBuffer();
   //   ::::str::ch().international::ACPToUnicode(pFilename, nSize, str);
